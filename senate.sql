...
INSERT INTO organizations(ORG_NAME, ORG_ACR, ORG_EMAIL, CURRENT_TIER, TIER_REQUEST, ORG_DESCRIPTION, CONSTITUTION, ORG_MEMBERS, ORG_ATTENDING_MEMBERS, BUDGET, APPROVAL_STATUS)
VALUES ("Alliance", NULL, "alliance@valpo.edu", "Tier 1", NULL, "Valpo's lgbt+ community", "link.imdyinginside.com", 45, 20, 2000, "yes"), ("Social Action Leadership Team", "SALT", "salt@valpo.edu", "Tier 2", "Tier 1", "Social justice ministry.", "everythingismeaningless.com/uuuuugh", 80, 46, 500, "Y");
...
("Keith Shmeith", "773-708-4561", "keith.shmeith@valpo.edu", "President", YEAR(CURDATE()), 1), ("Saddie Sadburg", "666-666-6666", "saddie.sadburg@valpo.edu", "Treasurer", YEAR(CURDATE()), 2), ("Um from Umbridge", "708-224-9999", "um.umbridge@valpo.edu", "Historian", YEAR(CURDATE()), 1);
...
VALUES ("Lana Mier", "798-675-9856", "lana.mier@valpo.edu", "Assistant Professor", 1), ("Mike Cath", "567-273-4561", "mike.cath@valpo.edu", "Doing his best", 2);
